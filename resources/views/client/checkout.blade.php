                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <div class="col-sm-3 col-xs-3">
                                    <img class="img-responsive" src="frontend/images/product-1.jpg" />
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="col-xs-12">Roboto Character</div>
                                    <div class="col-xs-12"><small>Quantity:<span> 1 set</span></small></div>
                                </div>
                                <div class="col-sm-3 col-xs-3 text-right">
                                    <h6><span>$</span>120.00</h6>
                                </div>
                            </div>
                            <div class="form-group">
                                <hr />
                            ...
                            <div class="form-group">
                                <div class="col-xs-12">
                                    ...
                                    <div class="pull-right"><span>$</span><span>120.00</span></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <hr />
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <button type="submit" class="btn btn-primary btn-submit-fix"
                                        style="padding: 10px;font-size: 15px;">Pay Now</button>
                                </div>
                            </div>
                        </div>
                    </div>
